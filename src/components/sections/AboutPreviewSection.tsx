  ...
  return (
    <section className="section-padding bg-white">
      <div className="container-page grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <div className="relative min-h-[470px] overflow-hidden border border-brand-line">
          ...
          <div className="absolute bottom-0 left-0 bg-brand-red px-7 py-6 text-white">
            ...
            <span className="mt-1 block text-sm text-white">sahada üretim ve uygulama deneyimi</span>
          </div>
        </div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {strengths.map((item) => (
              <div key={item} className="flex items-center gap-3 border-t border-brand-line pt-4 text-sm font-semibold text-brand-navy">
                <span className="grid h-7 w-7 shrink-0 place-items-center bg-brand-red text-white"><Check size={15} /></span>
                {item}
              </div>
            ))}
          </div>
