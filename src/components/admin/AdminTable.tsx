...
export function AdminTable({
  ...
  return (
    <section className="min-w-0 max-w-full overflow-hidden rounded-2xl border border-brand-line bg-white shadow-sm">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm" style={{ minWidth }}>
          <thead className="bg-slate-50/90 text-[11px] uppercase tracking-[0.08em] text-slate-500">
            <tr>
              {headers.map((header) => (
